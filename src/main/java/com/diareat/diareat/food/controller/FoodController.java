...
public class FoodController {
    ...
    @GetMapping
    public ApiResponse<List<ResponseFoodDto>> getFoodListByDate(@RequestHeader String accessToken,
                                                                @RequestParam int yy,
                                                                @RequestParam int mm,
                                                                @RequestParam int dd) {
    ...
    public ApiResponse<Void> deleteFood(@PathVariable Long foodId, @RequestHeader String accessToken,
                                        @RequestParam int yy,
                                        @RequestParam int mm,
                                        @RequestParam int dd) {
        Long userId = jwtTokenProvider.getUserPk(accessToken);
    ...
    @GetMapping("/favorite")
    public ApiResponse<List<ResponseFavoriteFoodDto>> getFavoriteFoodList(@RequestHeader String accessToken) {
        Long userId = jwtTokenProvider.getUserPk(accessToken);
    ...
    public ApiResponse<Void> deleteFavoriteFood(@PathVariable Long favoriteFoodId, @RequestHeader String accessToken) {
        Long userId = jwtTokenProvider.getUserPk(accessToken);
    ...
    public ApiResponse<ResponseNutritionSumByDateDto> getNutritionSumByDate(@RequestHeader String accessToken,
                                                                            @RequestParam int yy,
                                                                            @RequestParam int mm,
                                                                            @RequestParam int dd) {
        Long userId = jwtTokenProvider.getUserPk(accessToken);
    ...
    public ApiResponse<ResponseNutritionSumByDateDto> getNutritionSumByWeek(@RequestHeader String accessToken,
                                                                            @RequestParam int yy,
                                                                            @RequestParam int mm,
                                                                            @RequestParam int dd) {
        Long userId = jwtTokenProvider.getUserPk(accessToken);
    ...
    public ApiResponse<ResponseNutritionSumByDateDto> getNutritionSumByMonth(@RequestHeader String accessToken,
                                                                             @RequestParam int yy,
                                                                             @RequestParam int mm,
                                                                             @RequestParam int dd) {
        Long userId = jwtTokenProvider.getUserPk(accessToken);
    ...
    @GetMapping("/score")
    public ApiResponse<ResponseScoreBestWorstDto> getScoreOfUserWithBestAndWorstFoods(@RequestHeader String accessToken,
                                                                                      @RequestParam int yy,
                                                                                      @RequestParam int mm,
                                                                                      @RequestParam int dd
    ) {
    ...
    @GetMapping("/analysis")
    public ApiResponse<ResponseAnalysisDto> getAnalysisOfUser(@RequestHeader String accessToken,
                                                              @RequestParam int yy,
                                                              @RequestParam int mm,
                                                              @RequestParam int dd) {
        Long userId = jwtTokenProvider.getUserPk(accessToken);
    ...
    @GetMapping("/rank")
    public ApiResponse<List<ResponseRankUserDto>> getUserRankByWeek(@RequestHeader String accessToken,
                                                                    @RequestParam int yy,
                                                                    @RequestParam int mm,
                                                                    @RequestParam int dd) {
        Long userId = jwtTokenProvider.getUserPk(accessToken);
